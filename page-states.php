                        ...
                        <a href="<?php echo esc_url($state_link); ?>" 
                           class="group bg-white border border-gray-light rounded-xl p-6 hover:border-brand hover:shadow-lg transition-all duration-300 flex flex-col justify-between">
                            <div>
                                ...
                                <div class="space-y-1 text-sm text-graphite">
                                    <?php if ($clinic_count > 0) : ?>
                                        <p class="flex items-center gap-2">
                                            ...
                                            <span class="font-semibold"><?php echo esc_html($clinic_count); ?></span>
                                            <?php echo $clinic_count === 1 ? 'Clinic' : 'Clinics'; ?>
                                        </p>
                                    <?php endif; ?>
                                    <?php if ($city_count > 0) : ?>
                                        <p class="flex items-center gap-2">
                            ...
                            <div class="mt-4 flex items-center text-brand text-sm font-semibold group-hover:translate-x-1 transition-transform">
                                View Clinics
