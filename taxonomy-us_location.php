            ...
            <div class="max-w-[1440px] mx-auto px-4 md:px-8">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <h1 class="text-2xl md:text-3xl font-black text-charcoal tracking-tight">
                        ...
                        ?> Tattoo Removal Near <?php echo esc_html($current_term->name); ?>
                    </h1>
                ...
                <div class="col-span-1 lg:col-span-7">
                    <?php if ($clinics_query->have_posts()) : ?>
                        <div class="space-y-12">
                            ...
                            while ($clinics_query->have_posts()) : $clinics_query->the_post();
                                ...
                                $rating = get_post_meta($clinic_id, 'rating', true) ?: 0;
                                $review_count = get_post_meta($clinic_id, 'review_count', true) ?: 0;
                                $city = get_post_meta($clinic_id, 'city', true);
                                $price_range = get_post_meta($clinic_id, 'price_range', true);
                                ...
                                <div class="flex flex-col md:flex-row gap-6 pb-10 border-b border-gray-light hover:bg-offwhite/30 transition-colors p-4 -m-4 rounded-2xl group cursor-pointer">
                                    ...
                                    <div class="flex-1 flex flex-col min-w-0">
                                        ...
                                        <div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm font-bold text-graphite mb-4">
                                            <span>•</span>
                                            <span><?php echo esc_html($city ?: $current_term->name); ?></span>
                                            <span>•</span>
                    ...
                    <?php else : ?>
                        <div class="text-center py-12">
                            ...
                            <p class="text-graphite">There are no clinics in <?php echo esc_html($current_term->name); ?> yet.</p>
                        </div>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="bg-charcoal text-white rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
                            ...
                            <div class="relative z-10">
                                ...
                                <p class="text-slate-300 text-xs font-medium leading-relaxed mb-6">
                                    Add your clinic and get found by <span class="text-white font-black underline decoration-brand decoration-2 underline-offset-4">13,000 monthly visitors</span> looking for tattoo removal in <span class="text-brand font-black"><?php echo esc_html($current_term->name); ?></span>.
                                </p>
