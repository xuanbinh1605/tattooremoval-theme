                        ...
                        <div class="bg-white border border-gray-light rounded-2xl shadow-2xl p-8 space-y-8">
                            ...
                            <div class="pt-6 border-t border-gray-light">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <?php if ($facebook) : ?>
                                        <a href="<?php echo esc_url($facebook_url); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-10 h-10 bg-[#1877F2] hover:opacity-80 text-white rounded-lg transition-all shadow-sm hover:shadow-md">
                                    ...
                                    <?php if ($twitter) : ?>
                                        <a href="<?php echo esc_url($twitter_url); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-10 h-10 bg-[#000000] hover:opacity-80 text-white rounded-lg transition-all shadow-sm hover:shadow-md">
                                    ...
                                    <?php if ($instagram) : ?>
                                        <a href="<?php echo esc_url($instagram_url); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-80 text-white rounded-lg transition-all shadow-sm hover:shadow-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                    ...
                                    <?php if ($youtube) : ?>
                                        <a href="<?php echo esc_url($youtube_url); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-10 h-10 bg-[#FF0000] hover:opacity-80 text-white rounded-lg transition-all shadow-sm hover:shadow-md">
                                    ...
                                    <?php if ($linkedin) : ?>
                                        <a href="<?php echo esc_url($linkedin_url); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-10 h-10 bg-[#0A66C2] hover:opacity-80 text-white rounded-lg transition-all shadow-sm hover:shadow-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                    ...
                                    <?php if ($tiktok) : ?>
                                        <a href="<?php echo esc_url($tiktok_url); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-10 h-10 bg-[#000000] hover:opacity-80 text-white rounded-lg transition-all shadow-sm hover:shadow-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
